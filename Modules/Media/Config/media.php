...
return [
    ...
    'libraries'               => [
        'stylesheets' => [
            'vendor/Media/libraries/jquery-context-menu/jquery.contextMenu.min.css',
            'vendor/Media/css/media.css?v=' . time(),
        ],
        'javascript'  => [
            'vendor/Media/libraries/lodash/lodash.min.js',
            'vendor/Media/libraries/clipboard/clipboard.min.js',
            'vendor/Media/libraries/dropzone/dropzone.js',
            'vendor/Media/libraries/jquery-context-menu/jquery.ui.position.min.js',
            'vendor/Media/libraries/jquery-context-menu/jquery.contextMenu.min.js',
