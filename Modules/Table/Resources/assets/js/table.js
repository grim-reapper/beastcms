(($, DataTable) => {
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: (dt) => {
            return '<i class="fas fa-file-excel"></i> ' + dt.i18n('buttons.excel', ModulesVariables.languages.tables.excel);
        },
    ...
    DataTable.ext.buttons.export = {
        ...
        text: (dt) => {
            return '<i class="fa fa-download"></i> ' + dt.i18n('buttons.export', ModulesVariables.languages.tables.export) + '&nbsp;<span class="caret"/>';
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: (dt) => {
            return '<i class="fas fa-file-excel"></i> ' + dt.i18n('buttons.csv', ModulesVariables.languages.tables.csv);
        },
    ...
    DataTable.ext.buttons.print = {
        ...
        text: (dt) => {
            return '<i class="fa fa-print"></i> ' + dt.i18n('buttons.print', ModulesVariables.languages.tables.print);
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: (dt) => {
            return '<i class="fa fa-undo"></i> ' + dt.i18n('buttons.reset', ModulesVariables.languages.tables.reset);
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: (dt) => {
            return '<i class="fas fa-sync"></i> ' + dt.i18n('buttons.reload', ModulesVariables.languages.tables.reload);
        },
    ...
    class TableManagement {
        ...
        handleActionsRow() {
            ...
            $(document).on('click', '.delete-many-entry-trigger', (event) => {
                ...
                if (ids.length === 0) {
                    Modules.showError('Please select at least one record to perform this action!');
                    return false;
                }
        ...
        loadBulkChangeData($element) {
            ...
            $.ajax({
                ...
                success: (res) => {
                    ...
                    Modules.initResources();
                },
                error: (error) => {
                    Modules.handleError(error);
                }
            });
        }
