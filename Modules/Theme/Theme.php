...
use Modules\Theme\Exceptions\UnknownLayoutFileException;
use Modules\Theme\Exceptions\UnknownPartialFileException;
use Modules\Theme\Exceptions\UnknownThemeException;
...
class Theme implements ThemeContract
{
    ...
    public function getConfig($key = null)
    {
        // Main package config.
        if (!$this->themeConfig) {
            $this->themeConfig = $this->config->get('Theme.general');
        }
    ...
    {
        return $this->view->make('Theme::partials.header')->render();
    }
    ...
    {
        return $this->view->make('Theme::partials.footer')->render();
    }
