...
class ThemeOption
{
     ...
     * @return array
     */
    public function constructFields($sectionId = ''): array
    {
        $fields = [];
     ...
     * @param array $fields
     */
    public function processFieldsArray($sectionId = '', $fields = []): void
    {
     ...
     * @param bool $fields
     */
    public function removeSection($id = '', $fields = false): void
    {
        if (!empty($this->optName) && !empty($id)) {
            if (isset($this->sections[$this->optName][$id])) {
                $priority = '';
     ...
     * @param bool $hide
     */
    public function hideSection($id = '', $hide = true): void
    {
        $this->checkOptName();
     ...
     * @param bool $hide
     */
    public function hideField($id = '', $hide = true): void
    {
        $this->checkOptName();
     ...
     * @return bool
     */
    public function removeField($id = ''): bool
    {
        $this->checkOptName();
     ...
     * @return null
     */
    public function getArg($key = ''): ?string
    {
        $this->checkOptName();
    ...
    {
        Setting::set($this->getOptionKey($key, $this->getCurrentLocaleCode()), clean($value));
     ...
     * @return string
     */
    protected function getOptionKey($key, $locale): string
    {
