...
class ThemeController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('Theme::theme.custom_css'));
    ...
    {
        $file = public_path(config('Theme.general.themeDir') . '/' . $setting->get('theme') . '/css/style.integration.css');
    ...
    public function postRemoveTheme(
        ...
        return $response
            ->setError()
            ->setMessage(trans('Theme::theme.theme_is_note_existed'));
    }
}
