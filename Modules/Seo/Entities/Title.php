...
class Title implements TitleContract
{
    ...
    protected function init()
    {
        ...
        $this->setSeparator(config('Seo.general.title.separator', '-'));
        $this->switchPosition(config('Seo.general.title.first', true));
        $this->setMax(config('Seo.general.title.max', 55));
    }
     ...
     * @param  string $title
     *
     * @return \Modules\Seo\Entities\Title
     */
     ...
     * @param  int $max
     *
     * @throws \Modules\Seo\Exceptions\InvalidArgumentException
     */
