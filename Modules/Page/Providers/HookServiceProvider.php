...
class HookServiceProvider extends ServiceProvider
{
    ...
    public function addPageStatsWidget($widgets, $widgetSettings)
    {
        ...
        return (new DashboardWidgetInstance)
            ...
            ->setTitle(trans('Page::pages.pages'))
        ...
        if ($slug instanceof Eloquent) {
            ...
            if ($slug->reference_type === Page::class) {
                ...
                if (!empty($page)) {
                    ...
                    admin_bar()
                        ->registerLink(trans('Page::pages.edit_this_page'), route('pages.edit', $page->id));
    ...
    public function addSetting($data = null)
    {
        ...
        return $data . view('Page::setting', compact('pages'))->render();
    }
}
