...
<head>
    ...
    <link rel="icon shortcut" href="{{ setting('admin_favicon') ? get_image_url(setting('admin_favicon'), 'thumb') : url(config('Base.general.favicon')) }}">
    <link rel='stylesheet'
