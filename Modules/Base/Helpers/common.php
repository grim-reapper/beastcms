...
if (!function_exists('table_actions')) {
    ...
    {
        return view('Base::elements.tables.actions', compact('edit', 'delete', 'item', 'extra'))->render();
    }
}
...
if (!function_exists('anchor_link')) {
    ...
    function anchor_link($link, $name, array $options = []): string
    {
        ...
        return view('Base::elements.tables.link', compact('link', 'name', 'options'))->render();
    }
}
...
if (!function_exists('table_checkbox')) {
    ...
    {
        return view('Base::elements.tables.checkbox', compact('id'))->render();
    }
}
