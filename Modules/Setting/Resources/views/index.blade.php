    ...
    {!! Form::open(['route' => ['settings.edit']]) !!}
        <div class="max-width-1200">
            <div class="flexbox-annotated-section">
                ...
                <div class="flexbox-annotated-section-annotation">
                    <div class="annotated-section-title pd-all-20">
                        <h2>{{ trans('Setting::setting.general.general_block') }}</h2>
                    </div>
                    <div class="annotated-section-description pd-all-20 p-none-t">
                        <p class="color-note">{{ trans('Setting::setting.general.description') }}</p>
                    </div>
                </div>
                ...
                <div class="flexbox-annotated-section-content">
                    <div class="wrapper-content pd-all-20">
                        ...
                        <div class="form-group">
                            ...
                            <label class="text-title-field"
                                   for="rich_editor">{{ trans('Setting::setting.general.rich_editor') }}
                            </label>
                        ...
                        <div class="form-group">
                            <label class="text-title-field"
                                   for="default_admin_theme">{{ trans('Setting::setting.general.default_admin_theme') }}
                            </label>
                            <div class="ui-select-wrapper">
                                <select name="default_admin_theme" class="ui-select" id="default_admin_theme">
                                    @foreach(Assets::getThemes() as $theme => $path)
                                        <option value="{{ $theme }}" @if (setting('default_admin_theme', config('Base::general.default-theme')) === $theme) selected @endif>
                                            {{ Str::studly($theme) }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                                ...
                                <label><input type="checkbox" class="hrv-checkbox" value="1"
                                              @if (setting('enable_change_admin_theme')) checked @endif name="enable_change_admin_theme"> {{ trans('Setting::setting.general.enable_change_admin_theme') }} </label>
                        </div>

                        <div class="form-group">
                            <input type="hidden" name="enable_multi_language_in_admin" value="0">
                            <label><input type="checkbox" class="hrv-checkbox" value="1"
                                          @if (setting('enable_multi_language_in_admin')) checked @endif name="enable_multi_language_in_admin"> {{ trans('Setting::setting.general.enable_multi_language_in_admin') }} </label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flexbox-annotated-section">
                <div class="flexbox-annotated-section-annotation">
                    <div class="annotated-section-title pd-all-20">
                        <h2>{{ trans('Setting::setting.general.cache_block') }}</h2>
                    </div>
                    <div class="annotated-section-description pd-all-20 p-none-t">
                        <p class="color-note">{{ trans('Setting::setting.general.cache_description') }}</p>
                    </div>
                </div>
                ...
                <div class="flexbox-annotated-section-content">
                    <div class="wrapper-content pd-all-20">
                        ...
                        <div class="form-group">
                            <label class="text-title-field"
                                   for="enable_cache">{{ trans('Setting::setting.general.cache_admin_menu') }}
                            </label>
                            <label class="hrv-label">
