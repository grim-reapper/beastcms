...
class WidgetController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('Base::layouts.widgets'));
    ...
    public function postSaveWidgetToSidebar(Request $request, BaseHttpResponse $response)
    {
        try {
            ...
            return $response
                ->setData(view('Widget::item', compact('widget_areas'))->render())
                ->setMessage(trans('Widget::global.save_success'));
        } catch (Exception $ex) {
            return $response
                ->setError()
    ...
    public function postDelete(Request $request, BaseHttpResponse $response)
    {
        try {
            ...
            return $response->setMessage(trans('Widget::global.delete_success'));
        } catch (Exception $ex) {
            return $response
                ->setError()
                ->setMessage($ex->getMessage());
